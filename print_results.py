...
def print_results(results_dic, results_stats_dic, model, print_incorrect_dogs = False, print_incorrect_breed = False):
    ...
    print("Number of Dogs Images: "+str(results_stats_dic['n_dogs_img'])+"\n")
    print("Number of Images that are not Dogs: "+str(results_stats_dic['n_notdogs_img'])+"\n")

    print("Percentages: \n")
    print("Percentage of Correct Dogs: "+str(results_stats_dic['pct_correct_dogs'])+"\n")
    print("Percentage of Correct Breed: "+str(results_stats_dic['pct_correct_breed'])+"\n")
    print("Percentage of Correct not a Dog: "+str(results_stats_dic['pct_correct_notdogs'])+"\n")
        ...
        if results_stats_dic['n_correct_dogs'] + results_stats_dic['n_correct_notdogs'] != results_stats_dic['n_images']:
                ...
                for key in results_dic:
                        if sum(results_dic[key][3:]) == 1:
                                print('Pet Label: '+str(results_dic[key][0])+"\t Classifier Label: "+str(results_dic[key][1]))
        else:
